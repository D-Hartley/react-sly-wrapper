...
var _slyer = __webpack_require__(40);

var _slyer2 = _interopRequireDefault(_slyer);
...
var ReactSly = function (_React$PureComponent) {
  _inherits(ReactSly, _React$PureComponent);

  function ReactSly(p) {
    _classCallCheck(this, ReactSly);

    // instance of sly
    var _this = _possibleConstructorReturn(this, (ReactSly.__proto__ || Object.getPrototypeOf(ReactSly)).call(this, p));

    _this.frame = null;
    _this.sly = null; // ref of root el
    return _this;
  }

  _createClass(ReactSly, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.frame) {
        ...
        Array.prototype.forEach.call(itemEls, function (el) {
          el.style.width = containerWidth / _this2.props.itemsPerRow + 'px';
        });

        this.frame = new _slyer2.default(this.sly, Object.assign(options, this.props.options)).init();
...
function Sly(frame, options, callbackMap) {
  ...
  // Extend options
  var o = _jquery2.default.extend({}, Sly.defaults, options);
  ...
  // Frame
  var $frame = (0, _jquery2.default)(frame);
  var $slidee = o.slidee ? (0, _jquery2.default)(o.slidee).eq(0) : $frame.children().eq(0);
  var frameSize = 0;
  var slideeSize = 0;
  var pos = {
    start: 0,
    ...
    // Scrollbar
  };var $sb = (0, _jquery2.default)(o.scrollBar).eq(0);
  ...
  var hPos = {
    ...
    // Pagesbar
  };var $pb = (0, _jquery2.default)(o.pagesBar);
  var $pages = 0;
  var pages = [];
  ...
  // Miscellaneous
  var $scrollSource = o.scrollSource ? (0, _jquery2.default)(o.scrollSource) : $frame;
  var $dragSource = o.dragSource ? (0, _jquery2.default)(o.dragSource) : $frame;
  var $forwardButton = (0, _jquery2.default)(o.forward);
  var $backwardButton = (0, _jquery2.default)(o.backward);
  var $prevButton = (0, _jquery2.default)(o.prev);
  var $nextButton = (0, _jquery2.default)(o.next);
  var $prevPageButton = (0, _jquery2.default)(o.prevPage);
  var $nextPageButton = (0, _jquery2.default)(o.nextPage);
  var callbacks = {};
  var last = {};
  var animation = {};
  var move = {};
  ...
  function load(isInit) {
    ...
    // Save old position
    pos.old = _jquery2.default.extend({}, pos);
    ...
    if (itemNav) {
      ...
      var borderBox = (0, _jquery2.default)($items).css('boxSizing') === 'border-box';
    ...
    if (!parallax && frameSize > 0) {
      ...
      if ($pb[0] && lastPagesCount !== pages.length) {
        for (var _i = 0; _i < pages.length; _i++) {
          pagesHtml += o.pageBuilder.call(self, _i);
        }
  ...
  function render() {
    ...
    if (animation.immediate) {
      ...
      pos.cur = animation.from + animation.delta * _jquery2.default.easing[o.easing](animation.time / o.speed, animation.time, 0, 1, o.speed);
    }
  ...
  function getRelatives(slideePos) {
    ...
    if (itemNav) {
      ...
      // From start
      for (var _i2 = 0, il = items.length; _i2 < il; _i2++) {
        // First item
        if (first === false && slideePos <= items[_i2].start + items[_i2].half) {
          first = _i2;
        }

        // Center item
        if (center === false && slideePos <= items[_i2].center + items[_i2].half) {
          center = _i2;
        }

        // Last item
        if (_i2 === il - 1 || slideePos <= items[_i2].end + items[_i2].half) {
          _last = _i2;
          break;
        }
      }
      ...
      relatives.lastItem = isNumber(_last) ? _last : relatives.centerItem;
    }
  ...
  function updateRelatives(newPos) {
    _jquery2.default.extend(rel, getRelatives(newPos));
  }
  ...
  self.set = function (name, value) {
    if (_jquery2.default.isPlainObject(name)) {
      _jquery2.default.extend(o, name);
  ...
  function callbackIndex(name, fn) {
    for (var _i3 = 0, _l = callbacks[name].length; _i3 < _l; _i3++) {
      if (callbacks[name][_i3] === fn) {
        return _i3;
      }
    }
    return -1;
  ...
  function dragInit(event) {
    ...
    dragging.init = 0;
    dragging.$source = (0, _jquery2.default)(event.target);
  ...
  function dragEnd() {
    ...
    $doc.off(dragging.touch ? dragTouchEvents : dragMouseEvents, dragHandler);(dragging.slidee ? $slidee : $handle).removeClass(o.draggedClass);
  ...
  function isInteractive(element) {
    return ~_jquery2.default.inArray(element.nodeName, interactiveElements) || (0, _jquery2.default)(element).is(o.interactive);
  }
  ...
  self.destroy = function () {
    ...
    if (!parallax) {
      ...
      _jquery2.default.removeData(frame, namespace);
    }
...
Sly.getInstance = function (element) {
  return _jquery2.default.data(element, namespace);
};

Sly.storeInstance = function (element, sly) {
  return _jquery2.default.data(element, namespace, sly);
};

Sly.removeInstance = function (element) {
  return _jquery2.default.removeData(element, namespace);
};
...
function disableOneEvent(event) {
  stopDefault(event, 1);
  (0, _jquery2.default)(this).off(event.type, disableOneEvent);
}
...
// Default options
Sly.defaults = _defaults2.default;
